...
const NavBar = () => {
  const navlinkstyle = "text-[#297770] hover:text-[#dfb82b] focus:text-[#dfb82b] active:text-[#dfb82b] active:border-3";
  return (
    <>
                ...
                <Col md={6} className="text-base font-bold">
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                      <Nav className="me-auto active:text-[#dfb82b]">
                        <Nav.Link href="#home" className={navlinkstyle}>Home</Nav.Link>
                        <Nav.Link href="#features" className={navlinkstyle}>Features</Nav.Link>
                        <Nav.Link href="#about" className={navlinkstyle}>About</Nav.Link>
                        <Nav.Link href="#prayer times" className={navlinkstyle}>Prayer Times</Nav.Link>
                        <Nav.Link href="#articles" className={navlinkstyle}>Articles</Nav.Link>
